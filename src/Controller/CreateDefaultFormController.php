...
class CreateDefaultFormController extends AbstractController
{
    ...
    public function __construct(Security $security, private readonly FormTypeCollection $formTypeCollection, UrlGeneratorInterface $urlGenerator, CsrfTokenManagerInterface $csrfTokenManager, ParameterBagInterface $parameterBag, TranslatorInterface $translator)
    {
